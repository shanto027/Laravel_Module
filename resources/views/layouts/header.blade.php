...
<header class="main-header">
	<div class="d-flex align-items-center logo-box justify-content-start">
		...
		<a href="{{ url('/home') }}" class="logo">
		  <!-- logo-->
		  <div class="logo-lg">
			  <span class="light-logo"><img src="{{('admin_panel_assets/')}}/images/logo-dark-text.png" alt="logo"></span>
			  <span class="dark-logo"><img src="{{('admin_panel_assets/')}}/images/logo-dark-text.png" alt="logo"></span>
		  </div>
		</a>	
	</div>  
    <!-- Header Navbar -->
      ...
      <div class="navbar-custom-menu r-side">
        <ul class="nav navbar-nav">	
		  <li class="btn-group nav-item d-lg-flex d-none align-items-center">
			<p class="mb-0 text-fade pr-10 pt-5">{{  date("l") }}, {{ date("m.Y") }}</p>
		  </li>
